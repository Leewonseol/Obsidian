...
- [[_reports/실질-학습-우선순위|실질 학습 우선순위 전체 보고서]] — 54개 atomic Concept 전수 재계산, raw degree와 분리된 학습 우선순위

> 그래프 노드 크기는 구조적 연결성을 나타내며, 학습 중요도와 동일하지 않다. 실제 학습 순서는 고유 규칙 수와 핵심 문제 수를 우선한다.

**상위 10개 Concept**

| 순위 | Concept | 고유 규칙 | 핵심 Q | 실질 연결 | 상태 |
|---|---|---|---|---|---|
| 1 | [[NULL]] | 7 | 11 | 10 | 축메타영향·반복출제·실질중심 |
| 2 | [[정규화]] | 4 | 3 | 3 | 축메타영향·반복출제·실질중심·저평가가능 |
| 3 | [[TRUNCATE]] | 4 | 2 | 4 | 가족상호나열·실질중심 |
| 4 | [[집계 함수]] | 3 | 5 | 5 | 축메타영향·반복출제·실질중심 |
| 5 | [[윈도우 함수]] | 3 | 3 | 1 | 반복출제·실질중심·저평가가능 |
| 6 | [[정규표현식 함수]] | 3 | 3 | 0 | 반복출제·실질중심·저평가가능 |
| 7 | [[ERD]] | 3 | 2 | 9 | 반복출제·가족상호나열·실질중심 |
| 8 | [[서브쿼리]] | 3 | 2 | 0 | 반복출제·실질중심·저평가가능 |
| 9 | [[FK]] | 3 | 2 | 8 | 가족상호나열·실질중심 |
| 10 | [[DCL]] | 2 | 3 | 4 | 반복출제·가족상호나열·실질중심 |

**그래프상 과대평가 Concept (raw degree는 크지만 실질 순위는 낮음)**

| Concept | raw 순위 | 실질 순위 | 왜 커 보였나 |
|---|---|---|---|
| [[TCL]] | 10위 | 49위 | COMMIT·DCL·DDL·DML·ROLLBACK·Transaction이 서로를 나열(가족상호나열), 자체 근거는 사실상 0건 |
| [[식별자]] | 4위 | 43위 | ER모델링 가족 나열, 실제 근거는 1건뿐 |
| [[JOIN]] | 7위 | 44위 | A·B·C 3축 소속이 raw를 끌어올림, 고유 규칙은 1건뿐 |
| [[제약조건]] | 10위 | 47위 | 축 2개 + ER가족 나열, 자기 고유 문항 없음 |
| [[PK]] | 4위 | 25위 | ER가족 나열로 content_degree는 높으나 규칙은 1개뿐 |

**그래프상 저평가 Concept (raw degree는 작지만 실질 순위는 높음)**

| Concept | raw 순위 | 실질 순위 | 상승폭 |
|---|---|---|---|
| [[정규표현식 함수]] | 49위 | 6위 | 43단계 |
| [[서브쿼리]] | 43위 | 8위 | 35단계 |
| [[문자형 함수]] | 49위 | 17위 | 32단계 |
| [[윈도우 함수]] | 36위 | 5위 | 31단계 |
| [[정규화]] | 31위 | 2위 | 29단계 |
...
- [[_reports/유선배-모의고사1회-연결망-대조감사|유선배 모의고사 1회 연결망 대조 감사]]
- 유선배 모의고사의 출제 개념·규칙·관계와 현재 Concept–Question–Proposition 구조를 대조
- NULL 중심성의 유효성과 과대표현 가능성을 함께 검토
- 실제 구조 수정은 감사 결과와 추가 모의고사를 확인한 뒤 결정

## 유선배 1회 확정 규칙 보강

- [[Concepts/LIKE|LIKE·ESCAPE]]
- [[_reports/유선배1회-확정규칙-최소보강|유선배 1회 확정 규칙 최소 보강]]
- [[_reports/2차-문제집-반복누락-검증대기|두 번째 문제집 반복 누락 검증 대기]]
- 완전 누락된 LIKE만 새 Concept로 생성
- 기존 Concept는 확인된 세부 규칙만 보강
- 나머지 구조 변경은 두 번째 문제집 결과까지 보류
